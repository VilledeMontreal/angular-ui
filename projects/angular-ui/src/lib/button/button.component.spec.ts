...
import { TestButtonHostComponent } from './tests/button.hostcomponent.spec';
...
describe('BaoButtonComponent', () => {
  ...
  it('should apply class based on displayType', () => {
    ...
    fixture.detectChanges();
    expect(
      buttonDebugElement.nativeElement.classList.contains('bao-button-utility')
    ).toBe(true);
  ...
  it('should apply class based on level', () => {
    ...
    fixture.detectChanges();
    expect(
      buttonDebugElement.nativeElement.classList.contains('bao-button-primary')
    ).toBe(true);
    ...
    fixture.detectChanges();
    expect(
      buttonDebugElement.nativeElement.classList.contains('bao-button-tertiary')
    ).toBe(true);
  ...
  it('should apply class based on reversed', () => {
    ...
    fixture.detectChanges();
    expect(
      buttonDebugElement.nativeElement.classList.contains('bao-button-reversed')
    ).toBe(true);
  ...
  it('should apply class based on loading', () => {
    ...
    fixture.detectChanges();
    expect(
      buttonDebugElement.nativeElement.classList.contains('bao-button-loading')
    ).toBe(true);
