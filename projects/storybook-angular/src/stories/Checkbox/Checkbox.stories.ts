...
export const InlineCheckboxWithGuidingText: Story = {
  render: args => ({
    props: args,
    template: `
    <bao-checkbox-group>
  ...
  name: 'Inline checkbox with guiding text',
...
export const CheckboxDescriptionError: Story = {
  render: args => ({
    props: args,
    template: `
    <bao-checkbox-group>
  ...
  name: 'Checkbox - Description & error',
...
export const CheckboxDescriptionHiddenLabel: Story = {
  render: args => ({
    props: args,
    template: `
    <bao-checkbox-group>
  ...
  name: 'Checkbox - Description & hidden label',
...
export const CheckboxReactiveExample: Story = {
  render: args => ({
    props: args,
    template: `
  ...
  name: 'Checkbox - Reactive form example',
